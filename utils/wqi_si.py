...
def wqi_cd(value):
    ...
    '''
    from utils.tables import cd_table
    bpi = cd_table['bpi']
    qi = cd_table['qi']
    if value < bpi[0]:
        return 100
...
def wqi_pb(value):
    ...
    from utils.tables import pb_table
    bpi = pb_table['bpi']
    qi = pb_table['qi']
    if value < bpi[0]:
        return 100
...
def wqi_cr6(value):
    ...
    from utils.tables import cr6_table
    bpi = cr6_table['bpi']
    qi = cr6_table['qi']
    if value <= bpi[0]:
        return 100
...
def wqi_cu(value):
    ...
    from utils.tables import cu_table
    bpi = cu_table['bpi']
    qi = cu_table['qi']
    if value <= bpi[0]:
        return 100
...
def wqi_zn(value):
    ...
    '''
    from utils.tables import zn_table
    bpi = zn_table['bpi']
    qi = zn_table['qi']
    if value <= bpi[0]:
        return 100
...
def wqi_hg(value):
    ...
    '''
    from utils.tables import hg_table
    bpi = hg_table['bpi']
    qi = hg_table['qi']
    if value <= bpi[0]:
        return 100
...
def wqi_do(value, temperature):
    ...
    # step 2:
    from utils.tables import do_table
    bpi = do_table['bpi']
    qi = do_table['qi']
...
def wqi_bod5(value):
    ...
    '''
    from utils.tables import bod5_table
    bpi = bod5_table['bpi']
    qi = bod5_table['qi']
    if value <= bpi[0]:
        return 100
